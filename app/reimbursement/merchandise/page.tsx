...
// ─── PRESET ITEMS ────────────────────────────────────────────────────────────
// Prices converted from THB → USD at 32 THB/USD
const PRESET_ITEMS = [
  // ── เสื้อ / Apparel ──────────────────────────────────────────────────────
  { name: "เสื้อ VT logo White",             price: 4.69,  hasSize: true  },
  { name: "เสื้อ VT logo Blue",              price: 4.69,  hasSize: true  },
  { name: "เสื้อ VT 10Y Anniversary White",  price: 4.69,  hasSize: true  },
  { name: "เสื้อ VT 10Y Anniversary Black",  price: 4.69,  hasSize: true  },
  { name: "เสื้อ Bull Spectrum Polo Shirt",  price: 4.69,  hasSize: true  },
  { name: "เสื้อ VT เก่า",                  price: 4.69,  hasSize: true  },
  { name: "เสื้อกั๊ก Jacket CSR",           price: 3.13,  hasSize: true  },
  { name: "Hoodie VT",                       price: 9.38,  hasSize: true  },
  { name: "Jacket VT",                       price: 9.38,  hasSize: true  },
  { name: "เสื้อบอล NUFC",                  price: 31.25, hasSize: true  },
  { name: "Jacket NUFC (Gala)",             price: 62.50, hasSize: true  },
  // ── Accessories ──────────────────────────────────────────────────────────
  { name: "Mouse Pad VT10Y",                price: 4.69,  hasSize: false },
  { name: "Caps VT Logo",                   price: 2.50,  hasSize: false },
  { name: "Umbrella VT",                    price: 3.13,  hasSize: false },
  { name: "NUFC Cups",                      price: 3.13,  hasSize: false },
  { name: "Fluffy",                         price: 3.13,  hasSize: false },
  { name: "VT Markets Notebook (New)",      price: 2.50,  hasSize: false },
  { name: "VT Markets Notebook (Old)",      price: 2.50,  hasSize: false },
  { name: "Pen",                            price: 0.94,  hasSize: false },
  // ── Bags & Packaging ─────────────────────────────────────────────────────
  ...
  { name: "Tag Packaging Gala",            price: 1.56,  hasSize: false },
  // ── Event / Display ───────────────────────────────────────────────────────
